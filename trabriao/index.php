...
<body>
    <div class="container">
        ...
        <div class="button-group">
            ...
            <a href="nova_categoria.php" class="btn-secondary">+ Criar Nova Categoria</a>
            <a href="excluir_categoria.php" class="btn-danger">Excluir Categoria</a>
        </div>
        ...
        <div class="tabela">
            <table>
                ...
                <tbody>
                    <?php while($linha = mysqli_fetch_assoc($resultado)): // Calcula o subtotal transformando as linhas em arrays associativas
